...
Если у вас есть учетка на сайте Qt, то вводите данные, иначе нажимаете `Skip` (в 2020 году возможности пропустить ввода своей учетки нет, так что придется заводить учетку):
