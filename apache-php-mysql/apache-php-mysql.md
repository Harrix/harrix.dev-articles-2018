...
_Рисунок 18 — Проверка доступности HTML файла по адресу `http://phpmyadmin`_
...
![Файл `config.inc.php`](img/config-phpmyadmin.png)

_Рисунок 50 — Файл `config.inc.php`_
...
_Рисунок 51 — Запущенный phpMyAdmin_
