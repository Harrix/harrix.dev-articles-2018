...
- [Программа сложения двух чисел](#программа-сложения-двух-чисел)
- [Подключение пакетов и классов](#подключение-пакетов-и-классов)
- [Типы данных](#типы-данных)
- [Считывание данных с клавиатуры](#считывание-данных-с-клавиатуры)
- [Вывод текста на консоль](#вывод-текста-на-консоль)
...
- [Методы](#методы)
- [Массивы](#массивы)
- [Вычисление минимума среди нескольких чисел](#вычисление-минимума-среди-нескольких-чисел)
- [ООП](#ооп)
...
- [Рекурсия](#рекурсия)
- [Android](#android)
- [Примеры вывода текста в Android приложении](#примеры-вывода-текста-в-android-приложении)
  - [Рисование на канве в Android приложении](#рисование-на-канве-в-android-приложении)
  - [Команды рисования](#команды-рисования)
...
Например, методы в классе `Math` являются статическими, и не нужно создавать экземпляр класса `Math`, чтобы, например, посчитать квадратный корень `double x = Math.sqrt(4.0);`.
